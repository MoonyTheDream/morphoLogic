...
class ServerSettings(BaseSettings):
    ...
    SERVER_GENERAL_TOPIC: str = Field(
        default="serverGeneralTopic",
        description="Topic for general server messages"
    )
    CLIENTS_GENERAL_TOPIC: str = Field(
        default="clientsGeneralTopic",
        description="Topic for general client messages"
    )
    SERVER_HANDSHAKE_TOPIC: str = Field(
        default="serverHandshakeTopic",
        description="Topic for server handshake"
    )
    KAFKA_GROUP_ID: str = Field(
        default="morphoLogicServerGroup",
